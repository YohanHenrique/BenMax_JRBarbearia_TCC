	      ...
	      <div class="container">
	        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
	          <div class="col-md-6 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
	          	<h1 class="mb-3 mt-5 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Área do Sub-Administrador</h1>
	            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="<?= base_url(); ?>">Home</a></span> <span>Área do Sub-Adm</span></p>
	          </div>
	        </div>
	      </div>
	    </div>
	    	...
	    	<div class="container">
	    		<div class="row d-flex">
	    			...
	    			<div class="col-md-6 pl-md-5 ftco-animate">
	    				<h2 class="mb-4">Bem Vindo a Área de Sub-Administrador do Website da JR Barbearia.</h2>
	    				...
	    				<p>Essa área foi desenvolvida para que você <span>Sub-Administrador</span> possa ajudar a gerenciar a página, caso deseje: adicionar cliente, deletar uma mensagem
                        desrespeitosa, apagar uma avaliação que esteja incomodando outros clientes,  esses são alguns de seus poderes como <span>Sub-Administrador
                        </span>.</p>
	    			</div>
	    		</div>
	    	</div>
...
<div class="ftco-animate">
  ...
  <div class="row ftco-animate">
    ...
    <div class="col-lg-7 ftco-animate">
      ...
      <p>Como um sub-administrador da JR barbearia você recebe acesso a área de sub-administrador sempre que fizer login, nesta área você pode 
